...
$select_sql_for_duplicacy="select * from `designation_info` where `designation_name`='$id'";
...
else if( mysqli_num_rows($result) < 1)
{
    ...
    $insert_sql_statement="UPDATE `designation_info` SET `designation_name`='$designation_name' WHERE `id`= '$id'";

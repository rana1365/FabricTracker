...
$select_user="select * from `user_login` where `user_id`='$user_id'";
    ...
    <div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
        ...
        <form class="form-horizontal" action="" style="margin-top:10px;" name="edit_user_form" id="edit_user_form" enctype="multipart/form-data" data-parsley-validate>
            ...
            <div class="form-group form-group-sm" id="form-group_for_confirm_password">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="confirm_password" name="confirm_password" placeholder="Enter Confirm Password" value="<?php echo $row['password']?>" required>
                </div>
            ...
            <div class="form-group form-group-sm" id="form-group_for_designation">
                ...
                <div class="col-sm-5">
                    <select  class="form-control" id="designation" name="designation">
                        ...
                        $designation_sql = 'select designation_name from `designation_info` order by `designation_name`';;
                        ...
                        while ($designation_row = mysqli_fetch_assoc($designation_res))
                        {
                            ...
                            <option selected="selected" <?php if($designation_row['designation_name'] == $designation ){echo "selected";}?> value="<?php echo $designation_row['designation_name'];?>"> <?php echo $designation_row['designation_name'];?></option>
            ...
            <div class="form-group form-group-sm" id="form-group_for_profile_picture">
                ...
                <div class="col-sm-5">
                    <input type='file' class="form-control" id="profile_picture" name="profile_picture" size='35' value="<?php echo $row['profile_picture']?>" style='height:26px;border-radius: 4px;border: 1px solid #0AF1F0;'>
                </div>

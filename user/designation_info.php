                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" id="edit_designation" name="edit_designation"  class="btn btn-primary btn-xs" onclick="load_page('user/edit_designation_info.php?designation_id=<?php echo $row['id'] ?>')"> Edit </button>
                            <span>  </span>

                            <button type="submit" id="delete_designation" name="delete_designation"  class="btn btn-danger btn-xs" onclick="load_page('user/designation_info_deleting.php?designation_id=<?php echo $row['id'] ?>')"> Delete </button>
                        </td>
                            <?php

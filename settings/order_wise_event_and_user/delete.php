...
$delete_sql_statement="DELETE FROM `order_wise_event_and_user` WHERE `id`='$id'";
...
if($data_deleteion_hampering == "No" )
{
    ...
    echo "order_wise_event_and_user Info is successfully Deleted.";
...
else
{
    ...
    echo "order_wise_event_and_user Info is not successfully Deleted.";

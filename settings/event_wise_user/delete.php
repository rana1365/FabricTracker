...
$delete_sql_statement="DELETE FROM `event_wise_user` WHERE `id`='$id'";
...
if($data_deleteion_hampering == "No" )
{
    ...
    echo "Event wise user Info is successfully Deleted.";
...
else
{
    ...
    echo "Event wise user Info is not successfully Deleted.";

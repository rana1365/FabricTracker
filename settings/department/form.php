...
*/
?>
<script type='text/javascript' src='settings/department/form_validation.js'></script>
...
<script>
    function sending_data_of_department_info_form_for_saving_in_database()
    {
        ...
        {
            $.ajax({
                url: 'settings/department/saving.php',
                dataType: 'text',
                type: 'post',
                ...
                success: function( data, textStatus, jQxhr )
                {
                    ...
                    {
                        $.ajax({
                            url: 'settings/department/list.php',
                            dataType: 'text',
                            type: 'post',
                            contentType: 'application/x-www-form-urlencoded',
                            data: url_encoded_form_data,
        ...
        <div class="form-group form-group-sm" >
            <table id="datatable-buttons" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <button type="submit" id="edit_department" name="edit_department"  class="btn btn-primary btn-xs" onclick="load_page('settings/department/edit.php?department_id=<?php echo $row['id'] ?>')"> Edit </button>
                        <span>  </span>

                        <button type="submit" id="delete_department" name="delete_department"  class="btn btn-danger btn-xs" onclick="load_page('settings/department/delete.php?department_id=<?php echo $row['id'] ?>')"> Delete </button>
                    </td>
                    <?php
